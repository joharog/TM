              ...
              LOOP AT lt_com_yms ASSIGNING FIELD-SYMBOL(<lfs_com_yms>).
                ...
                IF lo_proxy IS BOUND.
                  TRY .
                    ...
                    CATCH cx_ai_system_fault INTO DATA(g_system_fault_u).
                      DATA(r_error_u) = abap_true.
                  ENDTRY.
                ENDIF.
                ...
                IF r_error IS INITIAL.
                  ...
                  ls_output-send_freight_order-freight_order-fo_number = |{ ls_output-send_freight_order-freight_order-fo_number ALPHA = OUT }|.
                  ls_output-send_freight_order-freight_order-sales_order = |{ ls_output-send_freight_order-freight_order-sales_order ALPHA = OUT }|.

                  CONCATENATE ls_output-send_freight_order-freight_order-fo_number
                              ls_output-send_freight_order-freight_order-werehaouse
                              INTO ls_bal_msg-msgv1 SEPARATED BY space.

                  CONCATENATE ls_output-send_freight_order-freight_order-sales_order
                              ls_output-send_freight_order-freight_order-operation
                              INTO ls_bal_msg-msgv2 SEPARATED BY space.
